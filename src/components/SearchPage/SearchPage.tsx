...
import { articleObj, SetKeyword } from "../../helpers/interfaces";
...
// W ifie:
// 5. Strzał do API axiosem, url: newsapi.org/v2/everything?q=*tutaj dynamicznie wstawiany stan
// keyword*&from=2022-11-14&language=en&sortBy=popularity&apiKey=${API_KEY}
...
// 2. Musimy przekazać funkcję aktualizującą stan do komponentu dziecka (props/context/redux/czymkolwiek czy sie da).
//  W przypadku propsów pamiętaj o interfejsie (typ: (value: *tu typ zmiennej stanowej* => void)) i o odebraniu funkcji
//  w child component w parametrze.
// 3. W środku child component wywołujemy funkcję (pkt 2), funkcja ta zawsze (!) będzie wiedzieć który stan w
// którym komponencie ma zaktualizować. Zmienna stanowa i setter są zawsze ze sobą związane, niezależnie gdzie się znajdą.
...
// 3. W List (u mnie linia 27) stwórz renderowanie warunkowe które będzie zależne od tego czy stan articles
// ma długość większą niż 0. Jeżeli warunek jest prawdziwy, wywołaj (cały czas w JSX'ie) metodę .map() na stanie articles.
// 4. .map() :
